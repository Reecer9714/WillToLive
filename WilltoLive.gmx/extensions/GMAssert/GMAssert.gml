...
///__gma_greater_than__(got, expected)
{
  var type = typeof(argument0);
  if (type == typeof(argument1)) {
    switch (type) {
...
///__gma_less_than__(got, expected)
{
  var type = typeof(argument0);
  if (type == typeof(argument1)) {
    switch (type) {
...
///__gma_greater_than_or_equal__(got, expected)
{
  var type = typeof(argument0);
  if (type == typeof(argument1)) {
    switch (type) {
...
///__gma_less_than_or_equal__(got, expected)
{
  var type = typeof(argument0);
  if (type == typeof(argument1)) {
    switch (type) {
